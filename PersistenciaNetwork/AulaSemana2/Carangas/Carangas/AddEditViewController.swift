...
class AddEditViewController: UIViewController {
    ...
    fileprivate func saveCar() {
        ...
        REST.save(car: car, onComplete: { (sucess) in
            ...
            self.showAlertError(withTitle: "Salvar", withMessage: response, isTryAgain: true, operation: .add_car)
        }
    }
    ...
    fileprivate func updateCar() {
        ...
        REST.update (car: car, onComplete: { (sucess) in
            ...
            self.showAlertError(withTitle: "Salvar", withMessage: response, isTryAgain: true, operation: .edit_car)
        }
    }
